...
import 'package:guide2/models/appbar.dart';
              ...
              child: Stack(
                ...
                children: <Widget>[
                  Container(
                    ...
                    width: 50,
                    child: CircleAvatar(
                      backgroundColor: follower.hasStory ? Colors.deepOrange[300] : Colors.white,
                    ),
                  ),
                  Container(
                    height: 47,
                ...
                Row(
                  children: <Widget>[
                    Stack(
                      alignment: Alignment(0, 0),
                      children: <Widget>[
                        Icon(Icons.favorite, size: 30, color: post.isLiked ? Colors.deepOrange[300] : Colors.black,),
                        IconButton(icon: Icon(Icons.favorite), color: post.isLiked ? Colors.deepOrange[300] : Colors.white,
                          onPressed: () {
                            setState(() {
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: FlatButton(
                    color: user.following.contains(follower) ? Colors.white : Colors.deepOrange[300],
                    child: Text(user.following.contains(follower) ? "Following" : "Follow", style: TextStyle(fontWeight: FontWeight.bold, color: user.following.contains(follower) ? Colors.grey[800]  : Colors.white)),
                    onPressed: () {
                      setState(() {
